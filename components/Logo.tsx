...
export function Logo() {
  return (
    <div className="flex items-center gap-2 sm:gap-3">
      <div className="relative w-10 h-10 sm:w-14 sm:h-14 rounded-full overflow-hidden border-2 border-white shadow-sm shrink-0">
        <Image
      ...
      <span className="font-serif text-lg sm:text-2xl font-bold text-[#6b1471]">
